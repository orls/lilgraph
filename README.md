...
```
// A node is an id, with optional attributes in square-brackets after. All attrs
// are treated as strings. The first attr item can be valueless; this is treated
// specially as the "type" property.
...
// To form edges, nodes don't have to be declared first (or, ever).

r2d2 -> sandcrawler
c3po -> sandcrawler

// Edges can have attributes too. These are declared in the middle of edges.
// Like nodes, the first value can be valueless and is treated as "type".
